...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      //for testin purposes im mockin a successful login
    ...
    <div className="flex min-h-screen w-full items-center justify-center p-4 font-sans">
      <Card className="mx-auto w-full max-w-md border-neutral-800 bg-neutral-900">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold font-mono">Sign in to GymBro</CardTitle>
          <CardDescription className="font-sans">Enter your email and password to access your account</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-neutral-400 hover:text-white font-sans">
                  Forgot password?
                </Link>
              </div>
              <Input
